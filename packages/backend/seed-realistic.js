    ...
    const users = await Promise.all([
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                name: 'Ana Lyst',
                passwordHash: await bcryptjs_1.default.hash('analyst123', 10),
                roles: {
                    create: { role: 'ANALYST' }
                }
            },
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                name: 'Dev Eloper',
                passwordHash: await bcryptjs_1.default.hash('dev123', 10),
                roles: {
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                name: 'View Only',
                passwordHash: await bcryptjs_1.default.hash('viewer123', 10),
                roles: {
                    create: { role: 'VIEWER' }
                }
            },
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                name: 'Rev Iewer',
                passwordHash: await bcryptjs_1.default.hash('reviewer123', 10),
                roles: {
                    create: { role: 'VIEWER' }
                }
            },
