  ...
  return (
    <Card interactive elevated={!!ultimoAnalisis} className="hover:border-blue-500/50 transition-all duration-300">
      ...
      <div className="mb-4">
        <div className="flex justify-between items-start gap-3 mb-3">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-xs px-2.5 py-1 rounded-full bg-gray-500/20 text-gray-300 border border-gray-500/30">
        ...
        {/* Repository URL */}
        <p className="text-xs text-gray-400 font-mono mb-2 truncate hover:text-gray-300 transition-colors">
...
function EstadoChip({ status }: { status: string }) {
  ...
  return (
    <span className={`px-2.5 py-1 rounded-full text-xs font-semibold flex items-center gap-1 ${cfg.clase}`}>
      <span>{cfg.icon}</span>
      {cfg.label}
    </span>
  );
