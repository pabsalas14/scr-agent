  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        label: 'Hallazgos',
        icon: AlertOctagon,
        description: 'Lista detallada de hallazgos',
        component: null as any,
        requiresAuth: true,
      },
      {
        ...
        label: 'Alertas',
        icon: Bell,
        description: 'Reglas y configuración',
        component: null as any,
        requiresAuth: true,
      },
      {
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        label: 'Sistema',
        icon: Zap,
        description: 'Estado de recursos',
        component: null as any,
        requiresAuth: true,
      },
      {
      ...
      },
      {
        ...
        label: 'Estadísticas',
        icon: BarChart3,
        description: 'Analytics profundos',
        component: null as any,
        requiresAuth: true,
      },
    ],
